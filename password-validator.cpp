...
//account structure containing name, username and password
struct account {
  //name is added as when you successfuly login it in greets you with ur account name rather than username
  string name;
  string username;
  string password;
};
